"use strict";(self.webpackChunksic_ui=self.webpackChunksic_ui||[]).push([[8903],{76727:function(a,r,n){var d;n.r(r),n.d(r,{demos:function(){return x}});var u=n(43953),s=n.n(u),f=n(91184),C=n.n(f),i=n(38497),v=n(80280),w=n(41420),y=n(95785),L=n(20187),_=n(63126),k=n(65014),P=n(77762),x={"iconui-demo-0":{component:i.memo(i.lazy(C()(s()().mark(function c(){var l,o,p,m,h,e,g;return s()().wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,Promise.resolve().then(n.t.bind(n,38497,19));case 2:return l=t.sent,o=l.default,t.next=6,Promise.resolve().then(n.bind(n,41420));case 6:return p=t.sent,m=p.Space,t.next=10,Promise.resolve().then(n.bind(n,95785));case 10:return h=t.sent,e=h.IconUI,g=function(){return o.createElement(m,{wrap:!0},o.createElement(e,{name:"Minsheng",width:24,height:24}),o.createElement(e,{name:"ListTwo",theme:"filled",size:"28",fill:"#1EAF69",strokeWidth:2}),o.createElement(e,{name:"Pingan",width:24,height:24}))},t.abrupt("return",{default:g});case 14:case"end":return t.stop()}},c)})))),asset:{type:"BLOCK",id:"iconui-demo-0",refAtomIds:["IconUI"],dependencies:{"index.tsx":{type:"FILE",value:`import React from 'react';\r
...
export default App;`},react:{type:"NPM",value:"18.3.1"},antd:{type:"NPM",value:"5.21.0"},"sic-ui":{type:"NPM",value:"0.4.16"}},entry:"index.tsx"},context:{react:d||(d=n.t(i,2)),antd:w,"sic-ui":y},renderOpts:{compile:function(){var c=C()(s()().mark(function o(){var p,m=arguments;return s()().wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,n.e(3687).then(n.bind(n,43687));case 2:return e.abrupt("return",(p=e.sent).default.apply(p,m));case 3:case"end":return e.stop()}},o)}));function l(){return c.apply(this,arguments)}return l}()}},"iconui-demo-dictionary":{component:i.memo(i.lazy(function(){return n.e(8992).then(n.bind(n,81578))})),asset:{type:"BLOCK",id:"iconui-demo-dictionary",refAtomIds:["IconUI"],dependencies:{"index.tsx":{type:"FILE",value:n(16322).Z},react:{type:"NPM",value:"18.3.1"},"sic-ui":{type:"NPM",value:"0.4.16"},"./dictionary.scss":{type:"FILE",value:n(35874).Z},"./rally.tsx":{type:"FILE",value:n(67601).Z},"@icon-park/react":{type:"NPM",value:"1.4.2"},"./material.tsx":{type:"FILE",value:n(33898).Z}},entry:"index.tsx"},context:{react:d||(d=n.t(i,2)),"sic-ui":y,"C:/Work/sic-ui/src/IconUI/material/dictionary.scss":L,"C:/Work/sic-ui/src/IconUI/material/rally.tsx":_,"@icon-park/react":k,"C:/Work/sic-ui/src/IconUI/material/material.tsx":P},renderOpts:{compile:function(){var c=C()(s()().mark(function o(){var p,m=arguments;return s()().wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,n.e(3687).then(n.bind(n,43687));case 2:return e.abrupt("return",(p=e.sent).default.apply(p,m));case 3:case"end":return e.stop()}},o)}));function l(){return c.apply(this,arguments)}return l}()}}}},20187:function(a,r,n){n.r(r)},37153:function(a,r,n){n.r(r),n.d(r,{texts:function(){return u}});var d=n(80280);const u=[{value:"\u56FD\u4FE1\u7075\u5DE5\u540E\u53F0\u7BA1\u7406\u7CFB\u7EDF-\u56FE\u6807\u7EC4\u4EF6",paraId:0},{value:"\u5730\u5740\uFF1A",paraId:1},{value:"IconPark",paraId:1},{value:"\u{1F48E} \u57FA\u7840\u4F7F\u7528",paraId:2,tocIndex:1},{value:`\u{1F48E} \u3010\u5B57\u5178\u67E5\u8BE2\u3011\u70B9\u51FB\u56FE\u6807\u590D\u5236\u4F7F\u7528\r
`,paraId:3}]},35874:function(a,r){r.Z=`.dictionary {\r
  display: flex;\r
  flex-wrap: wrap;\r
  &-item {\r
    height: 100px;\r
...
`},16322:function(a,r){r.Z=`import React from 'react';\r
...
`},33898:function(a,r){r.Z=`import React from 'react';\r
\r
interface IProps {\r
  color: string;\r
...
`},67601:function(a,r){r.Z=`import React from 'react';\r
import { Minsheng, Pingan, Iconwx, Iconzfb, Zhaoshang, Point } from './material';\r
import { UploadPdf, UploadImage, UploadExcel } from './material';\r
import { Export, Return, AddOne, Audit, Clear, Download, Female, Male, PreviewOpen, PreviewCloseOne, Upload } from '@icon-park/react';\r
...
import { FileStaff, Send, Local, Handbag, EveryUser, Passport, NewspaperFolding, Copyright, WritingFluently } from '@icon-park/react';\r
import { Platte, ArrowUp, Logout, Down, CheckCorrect, Square, Switch, MenuFoldOne, MenuUnfoldOne } from '@icon-park/react';\r
import { HamburgerButton, ListTwo, SwitchButton, Clue } from '@icon-park/react';\r
/** Icon \u96C6\u5408 */\r
export const iconRally = [\r
  ...
  { name: 'PreviewCloseOne', element: (props: any) => <PreviewCloseOne {...props} /> },\r
  ...
  { name: 'WritingFluently', element: (props: any) => <WritingFluently {...props} /> },\r
  { name: 'Platte', element: (props: any) => <Platte {...props} /> },\r
  { name: 'ArrowUp', element: (props: any) => <ArrowUp {...props} /> },\r
  { name: 'Logout', element: (props: any) => <Logout {...props} /> },\r
  { name: 'Down', element: (props: any) => <Down {...props} /> },\r
  { name: 'CheckCorrect', element: (props: any) => <CheckCorrect {...props} /> },\r
  { name: 'Square', element: (props: any) => <Square {...props} /> },\r
  { name: 'Switch', element: (props: any) => <Switch {...props} /> },\r
  { name: 'MenuFoldOne', element: (props: any) => <MenuFoldOne {...props} /> },\r
  { name: 'MenuUnfoldOne', element: (props: any) => <MenuUnfoldOne {...props} /> },\r
  { name: 'HamburgerButton', element: (props: any) => <HamburgerButton {...props} /> },\r
  { name: 'ListTwo', element: (props: any) => <ListTwo {...props} /> },\r
  { name: 'SwitchButton', element: (props: any) => <SwitchButton {...props} /> },\r
  { name: 'Clue', element: (props: any) => <Clue {...props} /> },\r
];\r
`}}]);
