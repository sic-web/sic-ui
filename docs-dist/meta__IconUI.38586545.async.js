"use strict";(self.webpackChunksic_ui=self.webpackChunksic_ui||[]).push([[8903],{38833:function(a,r,n){var d;n.r(r),n.d(r,{demos:function(){return x}});var u=n(43953),s=n.n(u),f=n(91184),C=n.n(f),i=n(38497),v=n(77570),w=n(35816),y=n(84351),L=n(69967),_=n(95637),k=n(65014),P=n(387),x={"iconui-demo-0":{component:i.memo(i.lazy(C()(s()().mark(function c(){var l,o,p,m,h,e,g;return s()().wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,Promise.resolve().then(n.t.bind(n,38497,19));case 2:return l=t.sent,o=l.default,t.next=6,Promise.resolve().then(n.bind(n,35816));case 6:return p=t.sent,m=p.Space,t.next=10,Promise.resolve().then(n.bind(n,84351));case 10:return h=t.sent,e=h.IconUI,g=function(){return o.createElement(m,{wrap:!0},o.createElement(e,{name:"Minsheng",width:24,height:24}),o.createElement(e,{name:"ListTwo",theme:"filled",size:"28",fill:"#1EAF69",strokeWidth:2}),o.createElement(e,{name:"Pingan",width:24,height:24}))},t.abrupt("return",{default:g});case 14:case"end":return t.stop()}},c)})))),asset:{type:"BLOCK",id:"iconui-demo-0",refAtomIds:["IconUI"],dependencies:{"index.tsx":{type:"FILE",value:`import React from 'react';\r
...
`},74673:function(a,r){r.Z=`import React from 'react';
...
import { HamburgerButton, ListTwo, SwitchButton, Clue } from '@icon-park/react';
/** Icon \u96C6\u5408 */
